...
isid: Item.o Enemy.o Player.o Pawn.o GraphMap.o Tile.o TiledMap.o Vec2D.o RenderedObject.o FileManager.o HUDElement.o HUD.o RenderManager.o GridMap.o GameManager.o isid.o
	...
	g++ $(CFLAGS) -o isid -g Item.o Enemy.o Player.o Pawn.o GraphMap.o Tile.o TiledMap.o Vec2D.o RenderedObject.o FileManager.o HUDElement.o HUD.o RenderManager.o GridMap.o GameManager.o isid.o $(LIBS)
